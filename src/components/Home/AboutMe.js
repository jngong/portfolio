        ...
        <div className='section-container about'>
            ...
            <div className='about-container'>
                <div className='about-text'>
                    <p>Diligent and detail-oriented software engineer with a strong background in content and digital marketing and a passion for creating intuitive, engaging user experiences.</p>
                    ...
                    <a href="https://drive.google.com/file/d/1QhcTiwjI-Enx9nyG-R-jCxcdGZWhT_IX/view" target="_blank">
